 	...
 	<div class="container module-frame" id="iframe">
			<div class="frame-title">
				...
				<div class="nowrap pull-right" style="margin-top:10px">
					<div class="ctdms-btn-small"><i class="glyphicon glyphicon-plus"></i> 添加用户</div> 
				    <div class="ctdms-btn-small btn-danger"><i class="glyphicon glyphicon-remove"></i> 删除用户</div> 
				</div>
			</div>
				    ...
				    <div class="row">
				        <div class="col-xs-3">
				            <div class="form-group" style="">
				                <input type="text" name="username" value="" placeholder="用户名" class="input-sm form-control">
				            </div>
				        </div>
				
				        <div class="col-xs-3">
				            <div class="form-group">
				                <input type="text" name="phone" value="" placeholder="手机号" class="input-sm form-control">
				            </div>
				        </div>
				
				        <div class="col-xs-1">
				            <div class="form-group">
				                <button type="submit" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-search"></i> 搜索</button>
				            </div>
				        </div>
				    </div>
				</form>
									...
									<tbody>
										<c:forEach var="s" items="${users }">
											<tr>
												...
												<td><a class=""
													href="">编辑</a> <span
													class="text-explode">|</span> <a class=""
													href="">授权</a> <span
													class="text-explode">|</span> <a class=""
													href="javascript:">密码</a><span
													...
													<span
													class="text-explode">|</span> <a class=""
													href="javascript:_delete(${s.userId })">删除</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
