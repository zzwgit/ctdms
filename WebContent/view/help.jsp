...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/stylepc.css">
	<style>
	.menu ul{
		width:239px;
	}
		...
		<div class="content">
			...
			<div class="menu1 menu_tab">
				<div id="tab1" class="tab active">
					<p class="tt">1.是如何收费？</p>
					<p>This is Answer！1.是如何收费？？1.是如何收费？？1.是如何收费？？1.是如何收费？？1.是如何收费？？</p>

					<p class="tt">2.安全吗？</p>
					<p>This is Answer！2.安全吗？2.安全吗？2.安全吗？2.安全吗？2.安全吗？2.安全吗？2.安全吗？</p>


					<p class="tt">3.的数据能否保存？</p>
					<p>的数据能否保存？的数据能否保存？的数据能否保存？</p>
					<p>的数据能否保存？</p>
...
<script type="text/javascript" src="<%=basePath%>js/pc.js"></script>
</html>
